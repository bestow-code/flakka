...
class Interval extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Interval', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.type'), createEmptyInstance: create)
    ..aOM<$9.Timestamp>(1, _omitFieldNames ? '' : 'startTime', subBuilder: $9.Timestamp.create)
    ..aOM<$9.Timestamp>(2, _omitFieldNames ? '' : 'endTime', subBuilder: $9.Timestamp.create)
  ...
  ///  or after the start.
  @$pb.TagNumber(1)
  $9.Timestamp get startTime => $_getN(0);
  @$pb.TagNumber(1)
  set startTime($9.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasStartTime() => $_has(0);
  @$pb.TagNumber(1)
  void clearStartTime() => clearField(1);
  @$pb.TagNumber(1)
  $9.Timestamp ensureStartTime() => $_ensure(0);
  ...
  ///  end.
  @$pb.TagNumber(2)
  $9.Timestamp get endTime => $_getN(1);
  @$pb.TagNumber(2)
  set endTime($9.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasEndTime() => $_has(1);
  @$pb.TagNumber(2)
  void clearEndTime() => clearField(2);
  @$pb.TagNumber(2)
  $9.Timestamp ensureEndTime() => $_ensure(1);
}
