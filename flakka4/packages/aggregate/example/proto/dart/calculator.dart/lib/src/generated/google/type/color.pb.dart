...
import '../protobuf/wrappers.pb.dart' as $24;
...
class Color extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Color', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.type'), createEmptyInstance: create)
    ...
    ..aOM<$24.FloatValue>(4, _omitFieldNames ? '' : 'alpha', subBuilder: $24.FloatValue.create)
  ...
  @$pb.TagNumber(4)
  $24.FloatValue get alpha => $_getN(3);
  @$pb.TagNumber(4)
  set alpha($24.FloatValue v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasAlpha() => $_has(3);
  @$pb.TagNumber(4)
  void clearAlpha() => clearField(4);
  @$pb.TagNumber(4)
  $24.FloatValue ensureAlpha() => $_ensure(3);
}
