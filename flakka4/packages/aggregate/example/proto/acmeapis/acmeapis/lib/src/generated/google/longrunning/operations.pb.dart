...
class Operation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Operation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.longrunning'), createEmptyInstance: create)
    ...
    ..aOM<$13.Any>(2, _omitFieldNames ? '' : 'metadata', subBuilder: $13.Any.create)
    ..aOB(3, _omitFieldNames ? '' : 'done')
    ..aOM<$15.Status>(4, _omitFieldNames ? '' : 'error', subBuilder: $15.Status.create)
    ..aOM<$13.Any>(5, _omitFieldNames ? '' : 'response', subBuilder: $13.Any.create)
  ...
  @$pb.TagNumber(2)
  set metadata($13.Any v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  $15.Status get error => $_getN(3);
  @$pb.TagNumber(4)
  set error($15.Status v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasError() => $_has(3);
  @$pb.TagNumber(4)
  void clearError() => clearField(4);
  @$pb.TagNumber(4)
  $15.Status ensureError() => $_ensure(3);
  ...
  @$pb.TagNumber(5)
  set response($13.Any v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class OperationsApi {
  ...
  ;
  $async.Future<$12.Empty> deleteOperation($pb.ClientContext? ctx, DeleteOperationRequest request) =>
    _client.invoke<$12.Empty>(ctx, 'Operations', 'DeleteOperation', request, $12.Empty())
  ;
  $async.Future<$12.Empty> cancelOperation($pb.ClientContext? ctx, CancelOperationRequest request) =>
    _client.invoke<$12.Empty>(ctx, 'Operations', 'CancelOperation', request, $12.Empty())
  ;
