...
import 'launch_stage.pbenum.dart' as $8;
...
class ClientLibrarySettings extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientLibrarySettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api'), createEmptyInstance: create)
    ...
    ..e<$8.LaunchStage>(2, _omitFieldNames ? '' : 'launchStage', $pb.PbFieldType.OE, defaultOrMaker: $8.LaunchStage.LAUNCH_STAGE_UNSPECIFIED, valueOf: $8.LaunchStage.valueOf, enumValues: $8.LaunchStage.values)
  ...
  @$pb.TagNumber(2)
  $8.LaunchStage get launchStage => $_getN(1);
  @$pb.TagNumber(2)
  set launchStage($8.LaunchStage v) { setField(2, v); }
  @$pb.TagNumber(2)
