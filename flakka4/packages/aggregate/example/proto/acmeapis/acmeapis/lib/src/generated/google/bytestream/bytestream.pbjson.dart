...
const $core.Map<$core.String, $core.dynamic> ByteStreamServiceBase$json = {
  '1': 'ByteStream',
  '2': [
    {'1': 'Read', '2': '.google.bytestream.ReadRequest', '3': '.google.bytestream.ReadResponse', '6': true},
    {'1': 'Write', '2': '.google.bytestream.WriteRequest', '3': '.google.bytestream.WriteResponse', '5': true},
    {'1': 'QueryWriteStatus', '2': '.google.bytestream.QueryWriteStatusRequest', '3': '.google.bytestream.QueryWriteStatusResponse'},
  ],
};

@$core.Deprecated('Use byteStreamServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> ByteStreamServiceBase$messageJson = {
...
/// Descriptor for `ByteStream`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List byteStreamServiceDescriptor = $convert.base64Decode(
    'CgpCeXRlU3RyZWFtEkkKBFJlYWQSHi5nb29nbGUuYnl0ZXN0cmVhbS5SZWFkUmVxdWVzdBofLm'
    'dvb2dsZS5ieXRlc3RyZWFtLlJlYWRSZXNwb25zZTABEkwKBVdyaXRlEh8uZ29vZ2xlLmJ5dGVz'
    'dHJlYW0uV3JpdGVSZXF1ZXN0GiAuZ29vZ2xlLmJ5dGVzdHJlYW0uV3JpdGVSZXNwb25zZSgBEm'
    'sKEFF1ZXJ5V3JpdGVTdGF0dXMSKi5nb29nbGUuYnl0ZXN0cmVhbS5RdWVyeVdyaXRlU3RhdHVz'
    'UmVxdWVzdBorLmdvb2dsZS5ieXRlc3RyZWFtLlF1ZXJ5V3JpdGVTdGF0dXNSZXNwb25zZQ==');
