...
class ParsedExpr extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ParsedExpr', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$16.SourceInfo>(3, _omitFieldNames ? '' : 'sourceInfo', subBuilder: $16.SourceInfo.create)
  ...
  @$pb.TagNumber(3)
  $16.SourceInfo get sourceInfo => $_getN(1);
  @$pb.TagNumber(3)
  set sourceInfo($16.SourceInfo v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSourceInfo() => $_has(1);
  @$pb.TagNumber(3)
  void clearSourceInfo() => clearField(3);
  @$pb.TagNumber(3)
  $16.SourceInfo ensureSourceInfo() => $_ensure(1);
...
class Literal extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Literal', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 5, 6, 7])
    ..e<$10.NullValue>(1, _omitFieldNames ? '' : 'nullValue', $pb.PbFieldType.OE, defaultOrMaker: $10.NullValue.NULL_VALUE, valueOf: $10.NullValue.valueOf, enumValues: $10.NullValue.values)
  ...
  /// null value.
  @$pb.TagNumber(1)
  $10.NullValue get nullValue => $_getN(0);
  @$pb.TagNumber(1)
  set nullValue($10.NullValue v) { setField(1, v); }
  @$pb.TagNumber(1)
