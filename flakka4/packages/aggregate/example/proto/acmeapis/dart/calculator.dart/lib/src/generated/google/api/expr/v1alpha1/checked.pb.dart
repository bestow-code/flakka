...
class CheckedExpr extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CheckedExpr', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1alpha1'), createEmptyInstance: create)
    ...
    ..aOM<$11.Expr>(4, _omitFieldNames ? '' : 'expr', subBuilder: $11.Expr.create)
    ..aOM<$11.SourceInfo>(5, _omitFieldNames ? '' : 'sourceInfo', subBuilder: $11.SourceInfo.create)
  ...
  @$pb.TagNumber(4)
  $11.Expr get expr => $_getN(2);
  @$pb.TagNumber(4)
  set expr($11.Expr v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasExpr() => $_has(2);
  @$pb.TagNumber(4)
  void clearExpr() => clearField(4);
  @$pb.TagNumber(4)
  $11.Expr ensureExpr() => $_ensure(2);

  /// The source info derived from input that generated the parsed `expr` and
  /// any optimizations made during the type-checking pass.
  @$pb.TagNumber(5)
  $11.SourceInfo get sourceInfo => $_getN(3);
  @$pb.TagNumber(5)
  set sourceInfo($11.SourceInfo v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasSourceInfo() => $_has(3);
  @$pb.TagNumber(5)
  void clearSourceInfo() => clearField(5);
  @$pb.TagNumber(5)
  $11.SourceInfo ensureSourceInfo() => $_ensure(3);
...
class Type extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Type', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1alpha1'), createEmptyInstance: create)
    ...
    ..aOM<$12.Empty>(1, _omitFieldNames ? '' : 'dyn', subBuilder: $12.Empty.create)
    ..e<$10.NullValue>(2, _omitFieldNames ? '' : 'null', $pb.PbFieldType.OE, defaultOrMaker: $10.NullValue.NULL_VALUE, valueOf: $10.NullValue.valueOf, enumValues: $10.NullValue.values)
    ...
    ..aOM<$12.Empty>(12, _omitFieldNames ? '' : 'error', subBuilder: $12.Empty.create)
  ...
  /// Dynamic type.
  @$pb.TagNumber(1)
  $12.Empty get dyn => $_getN(0);
  @$pb.TagNumber(1)
  set dyn($12.Empty v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDyn() => $_has(0);
  @$pb.TagNumber(1)
  void clearDyn() => clearField(1);
  @$pb.TagNumber(1)
  $12.Empty ensureDyn() => $_ensure(0);

  /// Null value.
  @$pb.TagNumber(2)
  $10.NullValue get null_2 => $_getN(1);
  @$pb.TagNumber(2)
  set null_2($10.NullValue v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(12)
  $12.Empty get error => $_getN(11);
  @$pb.TagNumber(12)
  set error($12.Empty v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasError() => $_has(11);
  @$pb.TagNumber(12)
  void clearError() => clearField(12);
  @$pb.TagNumber(12)
  $12.Empty ensureError() => $_ensure(11);
...
class Decl_IdentDecl extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Decl.IdentDecl', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1alpha1'), createEmptyInstance: create)
    ...
    ..aOM<$11.Constant>(2, _omitFieldNames ? '' : 'value', subBuilder: $11.Constant.create)
  ...
  @$pb.TagNumber(2)
  $11.Constant get value => $_getN(1);
  @$pb.TagNumber(2)
  set value($11.Constant v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasValue() => $_has(1);
  @$pb.TagNumber(2)
  void clearValue() => clearField(2);
  @$pb.TagNumber(2)
  $11.Constant ensureValue() => $_ensure(1);
...
class Reference extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Reference', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1alpha1'), createEmptyInstance: create)
    ...
    ..aOM<$11.Constant>(4, _omitFieldNames ? '' : 'value', subBuilder: $11.Constant.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $11.Constant get value => $_getN(2);
  @$pb.TagNumber(4)
  set value($11.Constant v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasValue() => $_has(2);
  @$pb.TagNumber(4)
  void clearValue() => clearField(4);
  @$pb.TagNumber(4)
  $11.Constant ensureValue() => $_ensure(2);
}
