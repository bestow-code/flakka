...
class ByteStreamApi {
  ...
  $async.Future<ReadResponse> read($pb.ClientContext? ctx, ReadRequest request) =>
    _client.invoke<ReadResponse>(ctx, 'ByteStream', 'Read', request, ReadResponse())
  ;
  $async.Future<WriteResponse> write($pb.ClientContext? ctx, WriteRequest request) =>
    _client.invoke<WriteResponse>(ctx, 'ByteStream', 'Write', request, WriteResponse())
  ;
  $async.Future<QueryWriteStatusResponse> queryWriteStatus($pb.ClientContext? ctx, QueryWriteStatusRequest request) =>
    _client.invoke<QueryWriteStatusResponse>(ctx, 'ByteStream', 'QueryWriteStatus', request, QueryWriteStatusResponse())
  ;
}
