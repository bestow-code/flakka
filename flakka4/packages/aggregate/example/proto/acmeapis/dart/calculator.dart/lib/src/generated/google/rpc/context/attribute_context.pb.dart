...
class AttributeContext_Auth extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext.Auth', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..aOM<$10.Struct>(4, _omitFieldNames ? '' : 'claims', subBuilder: $10.Struct.create)
  ...
  @$pb.TagNumber(4)
  set claims($10.Struct v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class AttributeContext_Request extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext.Request', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..aOM<$9.Timestamp>(9, _omitFieldNames ? '' : 'time', subBuilder: $9.Timestamp.create)
  ...
  /// the request.
  @$pb.TagNumber(9)
  $9.Timestamp get time => $_getN(7);
  @$pb.TagNumber(9)
  set time($9.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasTime() => $_has(7);
  @$pb.TagNumber(9)
  void clearTime() => clearField(9);
  @$pb.TagNumber(9)
  $9.Timestamp ensureTime() => $_ensure(7);
...
class AttributeContext_Response extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext.Response', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..aOM<$9.Timestamp>(4, _omitFieldNames ? '' : 'time', subBuilder: $9.Timestamp.create)
  ...
  /// the response.
  @$pb.TagNumber(4)
  $9.Timestamp get time => $_getN(3);
  @$pb.TagNumber(4)
  set time($9.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasTime() => $_has(3);
  @$pb.TagNumber(4)
  void clearTime() => clearField(4);
  @$pb.TagNumber(4)
  $9.Timestamp ensureTime() => $_ensure(3);
...
class AttributeContext_Resource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext.Resource', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..aOM<$9.Timestamp>(8, _omitFieldNames ? '' : 'createTime', subBuilder: $9.Timestamp.create)
    ..aOM<$9.Timestamp>(9, _omitFieldNames ? '' : 'updateTime', subBuilder: $9.Timestamp.create)
    ..aOM<$9.Timestamp>(10, _omitFieldNames ? '' : 'deleteTime', subBuilder: $9.Timestamp.create)
  ...
  @$pb.TagNumber(8)
  $9.Timestamp get createTime => $_getN(7);
  @$pb.TagNumber(8)
  set createTime($9.Timestamp v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasCreateTime() => $_has(7);
  @$pb.TagNumber(8)
  void clearCreateTime() => clearField(8);
  @$pb.TagNumber(8)
  $9.Timestamp ensureCreateTime() => $_ensure(7);

  /// Output only. The timestamp when the resource was last updated. Any
  /// change to the resource made by users must refresh this value.
  /// Changes to a resource made by the service should refresh this value.
  @$pb.TagNumber(9)
  $9.Timestamp get updateTime => $_getN(8);
  @$pb.TagNumber(9)
  set updateTime($9.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasUpdateTime() => $_has(8);
  @$pb.TagNumber(9)
  void clearUpdateTime() => clearField(9);
  @$pb.TagNumber(9)
  $9.Timestamp ensureUpdateTime() => $_ensure(8);

  /// Output only. The timestamp when the resource was deleted.
  /// If the resource is not deleted, this must be empty.
  @$pb.TagNumber(10)
  $9.Timestamp get deleteTime => $_getN(9);
  @$pb.TagNumber(10)
  set deleteTime($9.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasDeleteTime() => $_has(9);
  @$pb.TagNumber(10)
  void clearDeleteTime() => clearField(10);
  @$pb.TagNumber(10)
  $9.Timestamp ensureDeleteTime() => $_ensure(9);
...
class AttributeContext extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AttributeContext', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.rpc.context'), createEmptyInstance: create)
    ...
    ..pc<$13.Any>(8, _omitFieldNames ? '' : 'extensions', $pb.PbFieldType.PM, subBuilder: $13.Any.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(8)
  $core.List<$13.Any> get extensions => $_getList(7);
}
