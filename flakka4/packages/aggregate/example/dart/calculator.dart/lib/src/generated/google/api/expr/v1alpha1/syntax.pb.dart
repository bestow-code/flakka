...
class Constant extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Constant', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api.expr.v1alpha1'), createEmptyInstance: create)
    ...
    ..e<$4.NullValue>(1, _omitFieldNames ? '' : 'nullValue', $pb.PbFieldType.OE, defaultOrMaker: $4.NullValue.NULL_VALUE, valueOf: $4.NullValue.valueOf, enumValues: $4.NullValue.values)
    ...
    ..aOM<$1.Duration>(8, _omitFieldNames ? '' : 'durationValue', subBuilder: $1.Duration.create)
    ..aOM<$3.Timestamp>(9, _omitFieldNames ? '' : 'timestampValue', subBuilder: $3.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  /// null value.
  @$pb.TagNumber(1)
  $4.NullValue get nullValue => $_getN(0);
  @$pb.TagNumber(1)
  set nullValue($4.NullValue v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(9)
  $3.Timestamp get timestampValue => $_getN(8);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(9)
  set timestampValue($3.Timestamp v) { setField(9, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(9)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(9)
  $3.Timestamp ensureTimestampValue() => $_ensure(8);
}
