...
import 'any.pb.dart' as $7;
import 'source_context.pb.dart' as $16;
...
class Type extends $pb.GeneratedMessage {
  factory Type({
    ...
    $16.SourceContext? sourceContext,
    Syntax? syntax,
    $core.String? edition,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Type', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf'), createEmptyInstance: create)
    ...
    ..aOM<$16.SourceContext>(5, _omitFieldNames ? '' : 'sourceContext', subBuilder: $16.SourceContext.create)
  ...
  /// The source context.
  @$pb.TagNumber(5)
  $16.SourceContext get sourceContext => $_getN(4);
  @$pb.TagNumber(5)
  set sourceContext($16.SourceContext v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasSourceContext() => $_has(4);
  @$pb.TagNumber(5)
  void clearSourceContext() => clearField(5);
  @$pb.TagNumber(5)
  $16.SourceContext ensureSourceContext() => $_ensure(4);
...
class Enum extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Enum', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf'), createEmptyInstance: create)
    ...
    ..aOM<$16.SourceContext>(4, _omitFieldNames ? '' : 'sourceContext', subBuilder: $16.SourceContext.create)
  ...
  /// The source context.
  @$pb.TagNumber(4)
  $16.SourceContext get sourceContext => $_getN(3);
  @$pb.TagNumber(4)
  set sourceContext($16.SourceContext v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasSourceContext() => $_has(3);
  @$pb.TagNumber(4)
  void clearSourceContext() => clearField(4);
  @$pb.TagNumber(4)
  $16.SourceContext ensureSourceContext() => $_ensure(3);
...
class Option extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Option', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$7.Any>(2, _omitFieldNames ? '' : 'value', subBuilder: $7.Any.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $7.Any get value => $_getN(1);
  @$pb.TagNumber(2)
  set value($7.Any v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasValue() => $_has(1);
  @$pb.TagNumber(2)
  void clearValue() => clearField(2);
  @$pb.TagNumber(2)
  $7.Any ensureValue() => $_ensure(1);
}
