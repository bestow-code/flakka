...
import '../protobuf/any.pb.dart' as $7;
...
class Operation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Operation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.longrunning'), createEmptyInstance: create)
    ...
    ..aOM<$7.Any>(2, _omitFieldNames ? '' : 'metadata', subBuilder: $7.Any.create)
    ..aOB(3, _omitFieldNames ? '' : 'done')
    ..aOM<$9.Status>(4, _omitFieldNames ? '' : 'error', subBuilder: $9.Status.create)
    ..aOM<$7.Any>(5, _omitFieldNames ? '' : 'response', subBuilder: $7.Any.create)
  ...
  @$pb.TagNumber(2)
  $7.Any get metadata => $_getN(1);
  @$pb.TagNumber(2)
  set metadata($7.Any v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMetadata() => $_has(1);
  @$pb.TagNumber(2)
  void clearMetadata() => clearField(2);
  @$pb.TagNumber(2)
  $7.Any ensureMetadata() => $_ensure(1);
  ...
  @$pb.TagNumber(5)
  $7.Any get response => $_getN(4);
  @$pb.TagNumber(5)
  set response($7.Any v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasResponse() => $_has(4);
  @$pb.TagNumber(5)
  void clearResponse() => clearField(5);
  @$pb.TagNumber(5)
  $7.Any ensureResponse() => $_ensure(4);
}
...
class WaitOperationRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WaitOperationRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.longrunning'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$1.Duration>(2, _omitFieldNames ? '' : 'timeout', subBuilder: $1.Duration.create)
    ..hasRequiredFields = false
  ;
...
class OperationsApi {
  ...
  $async.Future<ListOperationsResponse> listOperations($pb.ClientContext? ctx, ListOperationsRequest request) =>
    _client.invoke<ListOperationsResponse>(ctx, 'Operations', 'ListOperations', request, ListOperationsResponse())
  ;
  $async.Future<Operation> getOperation($pb.ClientContext? ctx, GetOperationRequest request) =>
    _client.invoke<Operation>(ctx, 'Operations', 'GetOperation', request, Operation())
  ;
  $async.Future<$6.Empty> deleteOperation($pb.ClientContext? ctx, DeleteOperationRequest request) =>
    _client.invoke<$6.Empty>(ctx, 'Operations', 'DeleteOperation', request, $6.Empty())
  ;
  $async.Future<$6.Empty> cancelOperation($pb.ClientContext? ctx, CancelOperationRequest request) =>
    _client.invoke<$6.Empty>(ctx, 'Operations', 'CancelOperation', request, $6.Empty())
  ;
  $async.Future<Operation> waitOperation($pb.ClientContext? ctx, WaitOperationRequest request) =>
    _client.invoke<Operation>(ctx, 'Operations', 'WaitOperation', request, Operation())
  ;
}
