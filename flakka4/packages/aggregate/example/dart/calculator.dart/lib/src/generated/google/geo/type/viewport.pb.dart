...
import '../../type/latlng.pb.dart' as $14;
...
class Viewport extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Viewport', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.geo.type'), createEmptyInstance: create)
    ..aOM<$14.LatLng>(1, _omitFieldNames ? '' : 'low', subBuilder: $14.LatLng.create)
    ..aOM<$14.LatLng>(2, _omitFieldNames ? '' : 'high', subBuilder: $14.LatLng.create)
  ...
  @$pb.TagNumber(1)
  $14.LatLng get low => $_getN(0);
  @$pb.TagNumber(1)
  set low($14.LatLng v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasLow() => $_has(0);
  @$pb.TagNumber(1)
  void clearLow() => clearField(1);
  @$pb.TagNumber(1)
  $14.LatLng ensureLow() => $_ensure(0);

  /// Required. The high point of the viewport.
  @$pb.TagNumber(2)
  $14.LatLng get high => $_getN(1);
  @$pb.TagNumber(2)
  set high($14.LatLng v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasHigh() => $_has(1);
  @$pb.TagNumber(2)
  void clearHigh() => clearField(2);
  @$pb.TagNumber(2)
  $14.LatLng ensureHigh() => $_ensure(1);
}
