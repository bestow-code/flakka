...
import '../../../../google/type/datetime.pb.dart' as $4;
...
class A extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'A', package: const $pb.PackageName(_omitMessageNames ? '' : 'acmeapis.app1.taskmanager.v1'), createEmptyInstance: create)
    ..aOM<$4.DateTime>(1, _omitFieldNames ? '' : 'date', subBuilder: $4.DateTime.create)
  ...
  @$pb.TagNumber(1)
  $4.DateTime get date => $_getN(0);
  @$pb.TagNumber(1)
  set date($4.DateTime v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasDate() => $_has(0);
  @$pb.TagNumber(1)
  void clearDate() => clearField(1);
  @$pb.TagNumber(1)
  $4.DateTime ensureDate() => $_ensure(0);
}
