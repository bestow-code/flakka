...
class MessageWithNoOuter_NestedMessage extends $pb.GeneratedMessage {
  factory MessageWithNoOuter_NestedMessage({
    $core.int? i,
  }) {
    final $result = create();
    if (i != null) {
...
class MessageWithNoOuter extends $pb.GeneratedMessage {
  factory MessageWithNoOuter({
    MessageWithNoOuter_NestedMessage? nested,
    $core.Iterable<$5.TestAllTypes>? foreign,
    MessageWithNoOuter_NestedEnum? nestedEnum,
    EnumWithNoOuter? foreignEnum,
  }) {
    final $result = create();
    if (nested != null) {
    ...
    if (foreign != null) {
      $result.foreign.addAll(foreign);
    }
    if (nestedEnum != null) {
      $result.nestedEnum = nestedEnum;
    }
    if (foreignEnum != null) {
      $result.foreignEnum = foreignEnum;
    }
    return $result;
  }
