...
class FileGenerator2 extends FileGenerator {
  ...
  final serviceGenerators = <ServiceGenerator2>[];
  ...
  FileGenerator2(this.descriptor, this.options)
      : protoFileUri = Uri.file(descriptor.name),
        syntax = descriptor.syntax == 'proto3'
            ? ProtoSyntax.proto3
            : ProtoSyntax.proto2, super(descriptor, options) {
    ...
    for (final service in descriptor.service) {
      if (options.useGrpc) {
        ...
        final serviceGen =
            ServiceGenerator2(service, this, usedTopLevelServiceNames);
