...
class A extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'A',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'import_public'),
      createEmptyInstance: create)
    ..aOM<$13.Foo>(1, _omitFieldNames ? '' : 'a', subBuilder: $13.Foo.create)
