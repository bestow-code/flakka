...
class Top extends $pb.GeneratedMessage {
  factory Top({
    $core.Iterable<Nested>? nestedMessageList,
    $core.Map<$core.int, Nested>? nestedMessageMap,
    Nested? nestedMessage,
  }) {
    final $result = create();
    if (nestedMessageList != null) {
      $result.nestedMessageList.addAll(nestedMessageList);
    }
    if (nestedMessageMap != null) {
      $result.nestedMessageMap.addAll(nestedMessageMap);
    }
