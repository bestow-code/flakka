...
import 'package:flakka_journal/src/flakka_journal.dart';
...
void main() {
  group('FlakkaJournal', () {
    ...
    test('append event', () async {
      final flakkaJournal = FlakkaJournal(GetIt.instance);
      ...
      const path = '/o/1';
      final journalIO = await flakkaJournal
          .getJournalIO<TestEvent, TestState, TestView>(path);
      journalIO.effect.add(JournalEffect.event(
        ref: ref1,
        parent: ref0,
        event: event,
        stateView: stateView,
      ...
      final adapters = await flakkaJournal
