...
class ObjectLocalProvider extends PersistentNodeProvider<
    CoreProviderContext,
  ...
  factory ObjectLocalProvider.from(CoreStoreLocalProvider storeLocalProvider) =>
      ObjectLocalProvider(
        childProvider: PersistenceLocalProvider.from(storeLocalProvider),
      );
  @override
