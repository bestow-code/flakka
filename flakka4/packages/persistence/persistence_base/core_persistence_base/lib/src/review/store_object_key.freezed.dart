...
mixin _$ObjectStoreKey {
  ...
  ObjectKey<dynamic> get key => throw _privateConstructorUsedError;
...
abstract class $ObjectStoreKeyCopyWith<$Res> {
  ...
  @useResult
  $Res call({StorePath path, ObjectKey<dynamic> key});

  $StorePathCopyWith<$Res> get path;
  $ObjectKeyCopyWith<dynamic, $Res> get key;
}
...
class _$ObjectStoreKeyCopyWithImpl<$Res, $Val extends ObjectStoreKey>
  ...
  @pragma('vm:prefer-inline')
  $ObjectKeyCopyWith<dynamic, $Res> get key {
    return $ObjectKeyCopyWith<dynamic, $Res>(_value.key, (value) {
...
abstract class _ObjectStoreKey implements ObjectStoreKey {
  factory _ObjectStoreKey(final StorePath path, final ObjectKey<dynamic> key) =
      _$_ObjectStoreKey;

  @override
  StorePath get path;
  @override
  ObjectKey<dynamic> get key;
  @override
  @JsonKey(ignore: true)
  _$$_ObjectStoreKeyCopyWith<_$_ObjectStoreKey> get copyWith =>
      throw _privateConstructorUsedError;
