...
typedef TestApplicationIO = ApplicationIO<TestEvent, TestState, TestView>;
...
void main() {
  group('ApplicationIO', () {
    ...
    final ref0 = Ref('ref0');
    final ref1 = Ref('ref1');
    final state0 = ApplicationIOState(ref: ref0);

    final t1 = DateTime.fromMillisecondsSinceEpoch(1);
    group('ApplicationRequestEffect', () {
      group('Persist', () {
        blocTest<TestApplicationIO, ApplicationIOState>(
