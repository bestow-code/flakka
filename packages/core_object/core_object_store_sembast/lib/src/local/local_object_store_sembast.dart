...
class ObjectStoreLocalSembast<Event extends CoreEvent, State extends CoreState,
    View extends CoreView> implements LocalObjectStore<Event, State, View> {
  ObjectStoreLocalSembast({
