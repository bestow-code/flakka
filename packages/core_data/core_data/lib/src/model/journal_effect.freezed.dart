...
class _$JournalEffectAppendEvents<Event extends CoreEvent,
  ...
  @override
  String toString() {
    return 'JournalEffect<$Event, $State, $View>.appendEvent(ref: $ref, parent: $parent, event: $event, stateView: $stateView, createdAt: $createdAt, sequenceNumber: $sequenceNumber)';
  }
