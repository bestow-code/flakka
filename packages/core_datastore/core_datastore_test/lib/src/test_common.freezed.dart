...
TestEvent _$TestEventFromJson(Map<String, dynamic> json) {
  return _TestEvent.fromJson(json);
}
...
TestView _$TestViewFromJson(Map<String, dynamic> json) {
  return _TestView.fromJson(json);
}
...
mixin _$TestView {
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $TestViewCopyWith<TestView> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $TestViewCopyWith<$Res> {
  factory $TestViewCopyWith(TestView value, $Res Function(TestView) then) =
      _$TestViewCopyWithImpl<$Res, TestView>;
  @useResult
  $Res call({int value});
}

/// @nodoc
class _$TestViewCopyWithImpl<$Res, $Val extends TestView>
    implements $TestViewCopyWith<$Res> {
  _$TestViewCopyWithImpl(this._value, this._then);
