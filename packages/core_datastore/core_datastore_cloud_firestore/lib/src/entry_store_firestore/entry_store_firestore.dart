...
// class EntryStoreFirestore<Event extends CoreEvent> extends EntryStoreDelegate<Event> {
//   EntryStoreFirestore({
//     required CollectionReference<Entry> entryCollectionReference,
...
//     String path,
//     String headRef,
//     CoreEventConverter<Event> eventConverter, {
...
//             doc.data()!,
//             (json) =>
//                 eventConverter.fromJson(json! as Map<String, dynamic>),
//           ),
//           toFirestore: (data, options) =>
//               data.toJson(eventConverter.toJson),
//         );
...
//   //         required CoreEventConverter<Event> eventConverter,
//   //       }) =>
...
//   //     );
//
//   final CollectionReference<Entry> _entryCollectionReference;
...
//
//   @override
//   Future<Entry> get initialEntry async =>
//       (await _entryCollectionReference.doc(EntryRef.initial.value).get())
//           .data()!;
//
//   @override
//   Future<void> initialize(Entry Function() initialEntryFactory) async {
...
//
//   @override
//   Future<void> appendEntry(Entry entry) =>
...
typedef DocumentClaimAvailable = bool Function(DocumentSnapshot<Ref?>);
